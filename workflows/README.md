...
All available n8n workflow templates, organised by category.
...
|----------|-------------|------------|
| [Facebook Messenger OpenAI Chatbot](facebook-messenger-openai-chatbot/) | AI-powered Messenger chatbot with message batching, conversation memory, and OpenAI integration | `https://raw.githubusercontent.com/trendai-au-lab/n8n-workflow/main/workflows/facebook-messenger-openai-chatbot/workflow.json` |
| [Facebook Messenger Pinecone RAG Chatbot](facebook-messenger-pinecone-chatbot/) | Messenger chatbot with RAG capabilities using OpenAI and Pinecone Assistant for document-grounded responses | `https://raw.githubusercontent.com/trendai-au-lab/n8n-workflow/main/workflows/facebook-messenger-pinecone-chatbot/workflow.json` |
